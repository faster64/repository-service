(function(global, factory) {
    ...
    var _defaults = {
        ...
        instructionsPullToRefresh: 'Kéo xuống để tả lại',
        instructionsReleaseToRefresh: 'Thả tay để tải lại',
        instructionsRefreshing: '<i class="fa fa-spinner fa-pulse fa-3x fa-fw" style="color:#4BAC4D">',
        refreshTimeout: 500,
