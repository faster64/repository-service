...
set REPO_DOCKER=docker.citigo.com.vn/kvdev/kv-timesheet-bg-task:%BUILD_VERSION%
...
:: Build image
docker build -f ".\docker\background-task-worker\Dockerfile" -t %REPO_DOCKER% --build-arg DOCKER_IMAGE_BUILD_ARG=%DOCKER_IMAGE_BUILD_ARG% .
