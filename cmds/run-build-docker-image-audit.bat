...
set REPO_DOCKER=docker.citigo.com.vn/kvdev/kv-timesheet-audit-worker:%BUILD_VERSION%
...
:: Build image
docker build -f ".\docker\audit-worker\Dockerfile" -t %REPO_DOCKER% --build-arg DOCKER_IMAGE_BUILD_ARG=%DOCKER_IMAGE_BUILD_ARG% .
