...
namespace KiotVietTimeSheet.Domain.Utilities
{
    public static class LunarYearTools
    {
        ...
        {
            return INT(SunLongitude(dayNumber - 0.5 - (double)timeZone / 24) / PI * 6);
        }
        ...
        {
            return INT(NewMoon(k) + 0.5 + (double)timeZone / 24);
        }
        ...
        {
            long k, dayNumber, monthStart, a11, b11, lunarDay, lunarMonth, lunarYear;
        ...
        public static DateTime LunarToSolar(LunarDate ld, int timeZone)
        {
            ...
            if (b11 - a11 > 365)
            {
                ...
                //Fix for Ticket #6543
                if (ld.IsLeapYear && ld.Month == leapMonth || off >= leapOff && ld.Month != leapMonth)
                {
                    off += 1;
                }
            }
    ...
    public class LunarDate
    {
        ...
        {
            return Day + "/" + Month + "/" + Year + (IsLeapYear ? "N" : "");
        }
