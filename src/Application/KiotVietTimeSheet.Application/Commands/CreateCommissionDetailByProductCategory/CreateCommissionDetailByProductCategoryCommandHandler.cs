...
{
    public class CreateCommissionDetailByProductCategoryCommandHandler : BaseCommandHandler,
        IRequestHandler<CreateCommissionDetailByProductCategoryCommand, List<CommissionDetailDto>>
    {
        ...
        public CreateCommissionDetailByProductCategoryCommandHandler(
        ...
        public async Task<List<CommissionDetailDto>> Handle(CreateCommissionDetailByProductCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            var listProductWithCategory = await _kiotVietServiceClient.GetProductByCategoryId(
            ...
            await _timeSheetIntegrationEventService.AddEventAsync(
                new CreatedCommissionDetailByProductCategoryIntegrationEvent(result,
                    productCategory));
